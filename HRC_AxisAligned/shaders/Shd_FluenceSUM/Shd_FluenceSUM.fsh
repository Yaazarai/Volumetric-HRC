...
void main() {
	...
	radiance += sample2D(frustum_index0, vec2(-3.0, 0.0) / cascade_size, 0);
	radiance += sample2D(frustum_index1, vec2(-3.0, 0.0) / cascade_size, 1);
	radiance += sample2D(frustum_index2, vec2(-3.0, 0.0) / cascade_size, 2);
	radiance += sample2D(frustum_index3, vec2(-3.0, 0.0) / cascade_size, 3);
